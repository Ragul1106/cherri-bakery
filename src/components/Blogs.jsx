        ...
        <main className="bg-[#F8F1E9] text-[#0F0F0F] px-6 md:px-20 py-10 font-sans">
            ...
            <div className="flex flex-col md:flex-row  gap-10 items-center">
                <img
                    src={bread}
                    alt="Fresh Bread"
                    className="rounded-lg shadow-lg w-90 h-90 object-cover"
                />

                <div>
                    <h2 className="text-[18px] md:text-[28px] text-center font-semibold mb-4 leading-snug">
                        Fresh Bakes, Sweet Stories & Artisan Inspiration
                    </h2>
                    <p className="text-[15px] md:text-[20px] text-center font-semibold leading-relaxed">
