...
“We stop by after school for their chocolate chip cookies. Soft, gooey, and always fresh.”`,
  ...
  return (
    <div className="bg-[#FFF5ED] py-8 px-4 sm:px-8 lg:px-16 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto relative">
        ...
        <div className="hidden lg:flex absolute top-1/2 -right-12 transform -translate-y-1/2">
          <FaLongArrowAltRight className="text-black text-xl scale-x-[8] animate-slideRight" />
        </div>
      </div>
