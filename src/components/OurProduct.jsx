...
import cookiesImg from "../assets/images/cookiebiscuit.jpg";
...
import chocolatesImg from "../assets/images/chocholates.jpg";
            ...
            >
               <Link to={product.link}>
                <img
                  src={product.img}
                  alt={product.title}
                  className="w-full h-auto object-cover transform group-hover:scale-105 transition duration-300 cursor-pointer"
                />
              </Link>
              {/* Overlay */}
